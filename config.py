...
BOT_USERNAME = getenv("BOT_USERNAME", "ALISA_XMUSIC_PLAYER_BOT")
...
LOGGER_ID = int(getenv("LOGGER_ID", 1003636136724))
...
# Git
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/itsakermanlevi728292-blip/Alisamusicbot.git")
